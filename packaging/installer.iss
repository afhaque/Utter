...
[Setup]
AppId={{B7E8B7D4-6C1D-4E3B-9A5B-UTTER0100000}
AppName={#AppName}
...
Root: HKCU; Subkey: "Software\Microsoft\Windows\CurrentVersion\Run"; \
    ValueType: string; ValueName: "Utter"; ValueData: """{app}\utterd.exe"""; \
    Flags: uninsdeletevalue; Tasks: startup

[Run]
Filename: "{app}\utterd.exe"; Description: "Start Utter now"; \
